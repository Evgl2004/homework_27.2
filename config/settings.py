...
SECRET_KEY = 'django-insecure-chbufun)r^%s$ma_8!p!ca_fo^w-l2o*4+0p3pf#x+f-qim2hl'
...
CELERY_BROKER_URL = bool(getenv('CELERY_BROKER_URL')) # Например, Redis, который по умолчанию работает на порту 6379
